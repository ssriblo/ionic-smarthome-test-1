...
def target_temperature():  # noqa: E501
    t = TemperatureTargetGet()
    t.value = TV.targetT
    return t


def temperature_comfort():  # noqa: E501
    t = TemperatureTargetGet()
    t.value = TV.comfortT
    return t


def temperature_econom():  # noqa: E501
    t = TemperatureTargetGet()
    t.value = TV.economT
    return t


def temperature_room():  # noqa: E501
    t = TemperatureTargetGet()
    t.value = TV.airT
    return t


def temperature_water():  # noqa: E501
    t = TemperatureTargetGet()
    t.value = TV.waterT
    return t


def temperature_weather():  # noqa: E501
    t = TemperatureTargetGet()
...
def update_comfort_temperature(body):  # noqa: E501
...
def update_econom_temperature(body):  # noqa: E501
    if connexion.request.is_json:
        body = TemperaturePost.from_dict(connexion.request.get_json())  # noqa: E501
...
def update_target_temperature(body):  # noqa: E501
    if connexion.request.is_json:
#        import pprint
#        import json
